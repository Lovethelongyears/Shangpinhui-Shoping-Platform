...
// 删除购物产品的接口：URL：/api/cart/deleteCart/{skuId} 请求方式：delete
...
// 注册：URL：/api/user/passport/register 请求方式：post
export const reqUserResgiter = (data) => requests({ url: '/user/passport/register', data, method: 'post' })

// 登录：URL：/api/user/passport/login 请求方式：post
...
// 提交订单的接口：URL：/api/order/auth/submitOrder?tradeNo={tradeNo} 请求方式：post
